...
const HomePage = () => {
  return (
    <div className="flex w-full flex-col bg-white">
      {/* Hero Section */}
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-8 max-w-7xl mx-auto">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.28em] text-zinc-500">
              Hero Section
            </p>
            <h1 className="max-w-xl text-4xl font-bold leading-tight text-zinc-900 sm:text-5xl">
      ...
      <section className="px-4 py-12 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
            ...
            <h2 className="mt-2 text-3xl font-bold text-zinc-900">Quick overview blocks</h2>
            </div>

            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
                <p className="text-4xl font-bold text-zinc-900">05</p>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="mb-12">
          ...
          <h2 className="mt-2 text-3xl font-bold text-zinc-900">Explore Popular Cities</h2>
        </div>

        <div className="grid gap-8 md:grid-cols-3">
          {/* Shanghai */}
          <article className="group overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm hover:shadow-lg transition-all duration-300">
            <img
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-bold text-zinc-900">Shanghai City</h3>
              <p className="mt-3 text-sm leading-relaxed text-zinc-600">
                A vibrant mix of modern skyscrapers and traditional culture, perfect for city exploration.
              </p>
              <Button className="mt-6 w-full justify-center" variant="primary">
                View More
              </Button>
            </div>
          </article>
          ...
          <article className="group overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm hover:shadow-lg transition-all duration-300">
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-bold text-zinc-900">Cebu City</h3>
              <p className="mt-3 text-sm leading-relaxed text-zinc-600">
          ...
          <article className="group overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-sm hover:shadow-lg transition-all duration-300">
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-bold text-zinc-900">Seoul City</h3>
              <p className="mt-3 text-sm leading-relaxed text-zinc-600">
